...
namespace AmazonSpApiSDK.Models.FbaSmallandLight
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmallAndLightEligibility : IEquatable<SmallAndLightEligibility>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        public SmallAndLightEligibility(MarketplaceId MarketplaceId = default(MarketplaceId), SellerSKU SellerSKU = default(SellerSKU), SmallAndLightEligibilityStatus Status = default(SmallAndLightEligibilityStatus))
        {
            // to ensure "MarketplaceId" is required (not null)
            if (MarketplaceId == null)
            {
                throw new InvalidDataException("MarketplaceId is a required property for SmallAndLightEligibility and cannot be null");
            }
            else
            {
            ...
            if (SellerSKU == null)
            {
                throw new InvalidDataException("SellerSKU is a required property for SmallAndLightEligibility and cannot be null");
            }
            else
            {
            ...
            if (Status == null)
            {
                throw new InvalidDataException("Status is a required property for SmallAndLightEligibility and cannot be null");
            }
            else
            {
                this.Status = Status;
        ...
        {
            return this.Equals(input as SmallAndLightEligibility);
        }
