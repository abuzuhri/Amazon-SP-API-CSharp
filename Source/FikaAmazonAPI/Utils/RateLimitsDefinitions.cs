    ...
    internal static class RateLimitsDefinitions
    {
        internal static Dictionary<RateLimitType, RateLimits> RateLimitsTime()
        {
            ...
            return new Dictionary<RateLimitType, RateLimits>()
            {
              ...
              { RateLimitType.FulFillmentInbound_UpdateInboundPlanName,                     new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_UpdateShipmentName,                        new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_GenerateShipmentContentUpdatePreviews,     new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_GetShipmentContentUpdatePreview,           new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ConfirmShipmentContentUpdatePreview,       new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ConfirmDeliveryWindowOptions,              new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_GenerateDeliveryWindowOptions,             new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_UpdateShipmentSourceAddress,               new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_CreateMarketplaceItemLabels,               new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ListPackingGroupBoxes,                     new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ListShipmentBoxes,                         new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ListShipmentContentUpdatePreviews,         new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ListDeliveryWindowOptions,                 new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ListShipmentItems,                         new RateLimits(2.0M, 30) },
              { RateLimitType.FulFillmentInbound_ListShipmentPallets,                       new RateLimits(2.0M, 30) },
