...
using System.Linq;
using CancelShipmentResponse = AmazonSpApiSDK.Models.Shipping.CancelShipmentResponse;
using CreateShipmentRequest = AmazonSpApiSDK.Models.Shipping.CreateShipmentRequest;
using CreateShipmentResponse = AmazonSpApiSDK.Models.Shipping.CreateShipmentResponse;
using GetShipmentResponse = AmazonSpApiSDK.Models.Shipping.GetShipmentResponse;

namespace AmazonSpApiSDK.Api.Shipping
{
    /// <summary>
