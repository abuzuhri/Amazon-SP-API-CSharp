...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnfulfillablePreviewItemList : List<UnfulfillablePreviewItem>, IEquatable<UnfulfillablePreviewItemList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnfulfillablePreviewItemList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public UnfulfillablePreviewItemList() : base()
        {
        }
        ...
        {
            return this.Equals(input as UnfulfillablePreviewItemList);
        }
