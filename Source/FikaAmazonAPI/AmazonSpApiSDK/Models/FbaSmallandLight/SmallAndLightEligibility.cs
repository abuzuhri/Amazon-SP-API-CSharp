...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FbaSmallandLight
{
    ...
    public partial class SmallAndLightEligibility : IEquatable<SmallAndLightEligibility>, IValidatableObject
    {
        ...
        public SmallAndLightEligibility(String MarketplaceId = default(String), String SellerSKU = default(String), SmallAndLightEligibilityStatus Status = default(SmallAndLightEligibilityStatus))
        {
