...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FbaSmallandLight
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmallAndLightFeePreviews : IEquatable<SmallAndLightFeePreviews>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmallAndLightFeePreviews" /> class.
        /// </summary>
        /// <param name="Data">A list of fee estimates for the requested items. The order of the fee estimates will follow the same order as the items in the request, with duplicates removed..</param>
        public SmallAndLightFeePreviews(List<FeePreview> Data = default(List<FeePreview>))
        {
            this.Data = Data;
        }
        ...
        /// </summary>
        /// <value>A list of fee estimates for the requested items. The order of the fee estimates will follow the same order as the items in the request, with duplicates removed.</value>
        ...
        {
            return this.Equals(input as SmallAndLightFeePreviews);
        }
