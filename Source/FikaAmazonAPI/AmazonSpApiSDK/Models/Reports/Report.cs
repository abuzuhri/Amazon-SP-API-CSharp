...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Reports
{
    ...
    public partial class Report : IEquatable<Report>, IValidatableObject
    {
        ...
        /// <param name="ReportDocumentId">The identifier for the report document. Pass this into the getReportDocument operation to get the information you will need to retrieve and decrypt the report document&#39;s contents..</param>
