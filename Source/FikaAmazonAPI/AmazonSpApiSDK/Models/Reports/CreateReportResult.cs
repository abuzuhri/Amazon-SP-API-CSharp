...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Reports
{
    ...
    public partial class CreateReportResult : IEquatable<CreateReportResult>, IValidatableObject
    {
        ...
        public CreateReportResult(string ReportId = default(string))
        {
            // to ensure "ReportId" is required (not null)
            if (ReportId == null)
            {
                throw new InvalidDataException("ReportId is a required property for CreateReportResult and cannot be null");
            }
            else
            {
