...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoanServicingEventList : List<LoanServicingEvent>, IEquatable<LoanServicingEventList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoanServicingEventList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public LoanServicingEventList() : base()
        {
        }
        ...
        {
            return this.Equals(input as LoanServicingEventList);
        }
