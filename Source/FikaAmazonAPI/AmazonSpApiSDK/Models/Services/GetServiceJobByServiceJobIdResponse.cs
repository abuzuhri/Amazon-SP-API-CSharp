...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Services
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetServiceJobByServiceJobIdResponse : IEquatable<GetServiceJobByServiceJobIdResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The payload for the GetServiceJobByServiceJobId operation.</value>
        ...
        /// </summary>
        /// <value>An unexpected condition occurred during the GetServiceJobByServiceJobId operation.</value>
        ...
        {
            return this.Equals(input as GetServiceJobByServiceJobIdResponse);
        }

        /// <summary>
        /// Returns true if GetServiceJobByServiceJobIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetServiceJobByServiceJobIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetServiceJobByServiceJobIdResponse input)
        {
            if (input == null)
                return false;
