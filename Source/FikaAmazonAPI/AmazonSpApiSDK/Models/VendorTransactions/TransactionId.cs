...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorTransactions
{
    ...
    public partial class TransactionId : IEquatable<TransactionId>, IValidatableObject
    {
        ...
        {
            return Equals(input as TransactionId);
        }
        ...
        public bool Equals(TransactionId input)
        {
            ...
            return
                    ...
                    _TransactionId == input._TransactionId ||
                    _TransactionId != null &&
                    _TransactionId.Equals(input._TransactionId)
                ;
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (_TransactionId != null)
                    hashCode = hashCode * 59 + _TransactionId.GetHashCode();
                return hashCode;
            }
        }
