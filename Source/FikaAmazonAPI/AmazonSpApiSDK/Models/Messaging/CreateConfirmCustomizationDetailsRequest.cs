...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Messaging
{
    ...
    public partial class CreateConfirmCustomizationDetailsRequest :  IEquatable<CreateConfirmCustomizationDetailsRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateConfirmCustomizationDetailsRequest);
        }

        /// <summary>
        /// Returns true if CreateConfirmCustomizationDetailsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateConfirmCustomizationDetailsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateConfirmCustomizationDetailsRequest input)
        {
            if (input == null)
                return false;
