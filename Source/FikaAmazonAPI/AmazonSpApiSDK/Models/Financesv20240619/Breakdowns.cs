...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances.Model
{
    ...
    public partial class Breakdowns : List<Breakdown>,  IEquatable<Breakdowns>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as Breakdowns);
        }

        /// <summary>
        /// Returns true if Breakdowns instances are equal
        /// </summary>
        /// <param name="input">Instance of Breakdowns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Breakdowns input)
        {
            if (input == null)
                return false;
