...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Contexts : List<Context>,  IEquatable<Contexts>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns true if Contexts instances are equal
        /// </summary>
        /// <param name="input">Instance of Contexts to be compared</param>
        /// <returns>Boolean</returns>
