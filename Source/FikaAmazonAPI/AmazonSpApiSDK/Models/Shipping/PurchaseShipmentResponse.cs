...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Shipping
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseShipmentResponse : IEquatable<PurchaseShipmentResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseShipmentResponse" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The payload for purchaseShipment operation</value>
        ...
        {
            return this.Equals(input as PurchaseShipmentResponse);
        }

        /// <summary>
        /// Returns true if PurchaseShipmentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseShipmentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseShipmentResponse input)
        {
            if (input == null)
                return false;
