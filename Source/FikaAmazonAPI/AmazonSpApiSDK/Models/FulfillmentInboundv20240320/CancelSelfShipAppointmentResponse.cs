...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelSelfShipAppointmentResponse :  IEquatable<CancelSelfShipAppointmentResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelSelfShipAppointmentResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public CancelSelfShipAppointmentResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for CancelSelfShipAppointmentResponse and cannot be null");
            }
            else
            {
        ...
        public CancelSelfShipAppointmentResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelSelfShipAppointmentResponse {\n");
        ...
        {
            return this.Equals(input as CancelSelfShipAppointmentResponse);
        }

        /// <summary>
        /// Returns true if CancelSelfShipAppointmentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelSelfShipAppointmentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelSelfShipAppointmentResponse input)
        {
            if (input == null)
                return false;
