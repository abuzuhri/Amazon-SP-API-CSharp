...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelInboundPlanResponse :  IEquatable<CancelInboundPlanResponse>, IValidatableObject
    {
      
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelInboundPlanResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public CancelInboundPlanResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for CancelInboundPlanResponse and cannot be null");
            }
            else
            {
        ...
        public CancelInboundPlanResponse()
        {
        ...
        {
            return this.Equals(input as CancelInboundPlanResponse);
        }

        /// <summary>
        /// Returns true if CancelInboundPlanResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelInboundPlanResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelInboundPlanResponse input)
        {
            if (input == null)
                return false;
