...
{
    /// <summary>
    /// The response schema for the updateShipmentName operation.
    /// </summary>
    [DataContract]
    public partial class UpdateShipmentNameResponse : IEquatable<UpdateShipmentNameResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateShipmentNameResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public UpdateShipmentNameResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for UpdateShipmentNameResponse and cannot be null");
            }
            else
            {
        ...
        public UpdateShipmentNameResponse()
        {
        ...
        {
            return this.Equals(input as UpdateShipmentNameResponse);
        }

        /// <summary>
        /// Returns true if UpdateShipmentNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateShipmentNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateShipmentNameResponse input)
        {
            if (input == null)
                return false;
