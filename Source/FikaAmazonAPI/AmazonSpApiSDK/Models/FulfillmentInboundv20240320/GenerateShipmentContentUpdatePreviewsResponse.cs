...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateShipmentContentUpdatePreviewsResponse :  IEquatable<GenerateShipmentContentUpdatePreviewsResponse>, IValidatableObject
    {
        ...
        public GenerateShipmentContentUpdatePreviewsResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for GenerateShipmentContentUpdatePreviewsResponse and cannot be null");
            }
            else
            {
        ...
        public GenerateShipmentContentUpdatePreviewsResponse()
        {
        ...
        {
            return this.Equals(input as GenerateShipmentContentUpdatePreviewsResponse);
        }

        /// <summary>
        /// Returns true if GenerateShipmentContentUpdatePreviewsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateShipmentContentUpdatePreviewsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateShipmentContentUpdatePreviewsResponse input)
        {
            if (input == null)
                return false;
