...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfirmShipmentContentUpdatePreviewResponse :  IEquatable<ConfirmShipmentContentUpdatePreviewResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmShipmentContentUpdatePreviewResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public ConfirmShipmentContentUpdatePreviewResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for ConfirmShipmentContentUpdatePreviewResponse and cannot be null");
            }
            else
            {
        ...
        public ConfirmShipmentContentUpdatePreviewResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfirmShipmentContentUpdatePreviewResponse {\n");
        ...
        {
            return this.Equals(input as ConfirmShipmentContentUpdatePreviewResponse);
        }

        /// <summary>
        /// Returns true if ConfirmShipmentContentUpdatePreviewResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfirmShipmentContentUpdatePreviewResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfirmShipmentContentUpdatePreviewResponse input)
        {
            if (input == null)
                return false;
