...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeneratePlacementOptionsResponse :  IEquatable<GeneratePlacementOptionsResponse>, IValidatableObject
    {
        ...
        public GeneratePlacementOptionsResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for GeneratePlacementOptionsResponse and cannot be null");
            }
            else
            {
        ...
        public GeneratePlacementOptionsResponse()
        {
        ...
        {
            return this.Equals(input as GeneratePlacementOptionsResponse);
        }

        /// <summary>
        /// Returns true if GeneratePlacementOptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneratePlacementOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneratePlacementOptionsResponse input)
        {
            if (input == null)
                return false;
