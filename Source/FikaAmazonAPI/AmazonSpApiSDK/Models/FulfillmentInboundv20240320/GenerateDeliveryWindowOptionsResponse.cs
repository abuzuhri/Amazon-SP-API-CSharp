...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateDeliveryWindowOptionsResponse :  IEquatable<GenerateDeliveryWindowOptionsResponse>, IValidatableObject
    {
       
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateDeliveryWindowOptionsResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public GenerateDeliveryWindowOptionsResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for GenerateDeliveryWindowOptionsResponse and cannot be null");
            }
            else
            {
        ...
        public GenerateDeliveryWindowOptionsResponse()
        {
        ...
        {
            return this.Equals(input as GenerateDeliveryWindowOptionsResponse);
        }

        /// <summary>
        /// Returns true if GenerateDeliveryWindowOptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateDeliveryWindowOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateDeliveryWindowOptionsResponse input)
        {
            if (input == null)
                return false;
