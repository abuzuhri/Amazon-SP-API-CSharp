...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateSelfShipAppointmentSlotsResponse :  IEquatable<GenerateSelfShipAppointmentSlotsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateSelfShipAppointmentSlotsResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public GenerateSelfShipAppointmentSlotsResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for GenerateSelfShipAppointmentSlotsResponse and cannot be null");
            }
            else
            {
        ...
        public GenerateSelfShipAppointmentSlotsResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateSelfShipAppointmentSlotsResponse {\n");
        ...
        {
            return this.Equals(input as GenerateSelfShipAppointmentSlotsResponse);
        }

        /// <summary>
        /// Returns true if GenerateSelfShipAppointmentSlotsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateSelfShipAppointmentSlotsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateSelfShipAppointmentSlotsResponse input)
        {
            if (input == null)
                return false;
