...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfirmPlacementOptionResponse :  IEquatable<ConfirmPlacementOptionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfirmPlacementOptionResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for ConfirmPlacementOptionResponse and cannot be null");
            }
            else
            {
        ...
        public ConfirmPlacementOptionResponse()
        {
        ...
        {
            return this.Equals(input as ConfirmPlacementOptionResponse);
        }

        /// <summary>
        /// Returns true if ConfirmPlacementOptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfirmPlacementOptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfirmPlacementOptionResponse input)
        {
            if (input == null)
                return false;
