...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateShipmentSourceAddressResponse :  IEquatable<UpdateShipmentSourceAddressResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateShipmentSourceAddressResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public UpdateShipmentSourceAddressResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for UpdateShipmentSourceAddressResponse and cannot be null");
            }
            else
            {
        ...
        public UpdateShipmentSourceAddressResponse()
        {
        ...
        {
            return this.Equals(input as UpdateShipmentSourceAddressResponse);
        }

        /// <summary>
        /// Returns true if UpdateShipmentSourceAddressResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateShipmentSourceAddressResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateShipmentSourceAddressResponse input)
        {
            if (input == null)
                return false;
