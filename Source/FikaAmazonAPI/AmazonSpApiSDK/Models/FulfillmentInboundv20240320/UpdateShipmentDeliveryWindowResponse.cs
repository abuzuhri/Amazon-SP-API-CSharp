...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateShipmentDeliveryWindowResponse :  IEquatable<UpdateShipmentDeliveryWindowResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateShipmentDeliveryWindowResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public UpdateShipmentDeliveryWindowResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for UpdateShipmentDeliveryWindowResponse and cannot be null");
            }
            else
            {
        ...
        public UpdateShipmentDeliveryWindowResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateShipmentDeliveryWindowResponse {\n");
        ...
        {
            return this.Equals(input as UpdateShipmentDeliveryWindowResponse);
        }

        /// <summary>
        /// Returns true if UpdateShipmentDeliveryWindowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateShipmentDeliveryWindowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateShipmentDeliveryWindowResponse input)
        {
            if (input == null)
                return false;
