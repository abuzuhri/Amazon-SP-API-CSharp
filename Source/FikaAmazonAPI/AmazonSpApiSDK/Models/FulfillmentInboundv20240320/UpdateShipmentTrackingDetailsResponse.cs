...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateShipmentTrackingDetailsResponse :  IEquatable<UpdateShipmentTrackingDetailsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateShipmentTrackingDetailsResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public UpdateShipmentTrackingDetailsResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for UpdateShipmentTrackingDetailsResponse and cannot be null");
            }
            else
            {
        ...
        public UpdateShipmentTrackingDetailsResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateShipmentTrackingDetailsResponse {\n");
        ...
        {
            return this.Equals(input as UpdateShipmentTrackingDetailsResponse);
        }

        /// <summary>
        /// Returns true if UpdateShipmentTrackingDetailsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateShipmentTrackingDetailsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateShipmentTrackingDetailsResponse input)
        {
            if (input == null)
                return false;
