...
{
    /// <summary>
    /// The response schema for the updateInboundPlanName operation.
    /// </summary>
    [DataContract]
    public partial class UpdateInboundPlanNameResponse : IEquatable<UpdateInboundPlanNameResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateInboundPlanNameResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public UpdateInboundPlanNameResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for UpdateInboundPlanNameResponse and cannot be null");
            }
            else
            {
        ...
        public UpdateInboundPlanNameResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelInboundPlanResponse {\n");
        ...
        {
            return this.Equals(input as UpdateInboundPlanNameResponse);
        }

        /// <summary>
        /// Returns true if UpdateInboundPlanNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateInboundPlanNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateInboundPlanNameResponse input)
        {
            if (input == null)
                return false;
