...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateTransportationOptionsResponse :  IEquatable<GenerateTransportationOptionsResponse>, IValidatableObject
    {
       
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateTransportationOptionsResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public GenerateTransportationOptionsResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for GenerateTransportationOptionsResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GenerateTransportationOptionsResponse);
        }

        /// <summary>
        /// Returns true if GenerateTransportationOptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateTransportationOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateTransportationOptionsResponse input)
        {
            if (input == null)
                return false;
