...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfirmTransportationOptionsResponse :  IEquatable<ConfirmTransportationOptionsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmTransportationOptionsResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public ConfirmTransportationOptionsResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for ConfirmTransportationOptionsResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ConfirmTransportationOptionsResponse);
        }

        /// <summary>
        /// Returns true if ConfirmTransportationOptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfirmTransportationOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfirmTransportationOptionsResponse input)
        {
            if (input == null)
                return false;
