...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeneratePackingOptionsResponse :  IEquatable<GeneratePackingOptionsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneratePackingOptionsResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public GeneratePackingOptionsResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for GeneratePackingOptionsResponse and cannot be null");
            }
            else
            {
        ...
        public GeneratePackingOptionsResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GeneratePackingOptionsResponse {\n");
        ...
        {
            return this.Equals(input as GeneratePackingOptionsResponse);
        }

        /// <summary>
        /// Returns true if GeneratePackingOptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneratePackingOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneratePackingOptionsResponse input)
        {
            if (input == null)
                return false;
