...
{
    /// <summary>
    /// &#x60;listPackingGroupBoxes&#x60; response.
    /// </summary>
    [DataContract]
    public partial class ListPackingGroupBoxesResponse :  IEquatable<ListPackingGroupBoxesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ListPackingGroupBoxesResponse(List<Box> boxes = default(List<Box>), Pagination pagination = default(Pagination))
        {
            ...
            if (boxes == null)
            {
                throw new InvalidDataException("boxes is a required property for ListPackingGroupBoxesResponse and cannot be null");
            }
            else
            {
                this.Boxes = boxes;
        ...
        /// </summary>
        /// <value>Provides the information about the list of boxes in the packing group.</value>
        ...
        {
            return this.Equals(input as ListPackingGroupBoxesResponse);
        }

        /// <summary>
        /// Returns true if ListPackingGroupBoxesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListPackingGroupBoxesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListPackingGroupBoxesResponse input)
        {
            if (input == null)
                return false;
