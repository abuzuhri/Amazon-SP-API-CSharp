...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateItemComplianceDetailsResponse :  IEquatable<UpdateItemComplianceDetailsResponse>, IValidatableObject
    {
      
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateItemComplianceDetailsResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public UpdateItemComplianceDetailsResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for UpdateItemComplianceDetailsResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UpdateItemComplianceDetailsResponse);
        }

        /// <summary>
        /// Returns true if UpdateItemComplianceDetailsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateItemComplianceDetailsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateItemComplianceDetailsResponse input)
        {
            if (input == null)
                return false;
