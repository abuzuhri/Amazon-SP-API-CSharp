...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInboundv20240320
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfirmPackingOptionResponse :  IEquatable<ConfirmPackingOptionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmPackingOptionResponse" /> class.
        /// </summary>
        /// <param name="operationId">UUID for the given operation. (required).</param>
        public ConfirmPackingOptionResponse(string operationId = default(string))
        {
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new InvalidDataException("operationId is a required property for ConfirmPackingOptionResponse and cannot be null");
            }
            else
            {
        ...
        public ConfirmPackingOptionResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfirmPackingOptionResponse {\n");
        ...
        {
            return this.Equals(input as ConfirmPackingOptionResponse);
        }

        /// <summary>
        /// Returns true if ConfirmPackingOptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfirmPackingOptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfirmPackingOptionResponse input)
        {
            if (input == null)
                return false;
