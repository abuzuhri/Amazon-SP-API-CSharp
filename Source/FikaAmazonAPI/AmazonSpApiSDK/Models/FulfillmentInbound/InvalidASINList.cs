...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvalidASINList : List<InvalidASIN>, IEquatable<InvalidASINList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidASINList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public InvalidASINList() : base()
        {
        }
        ...
        {
            return this.Equals(input as InvalidASINList);
        }
