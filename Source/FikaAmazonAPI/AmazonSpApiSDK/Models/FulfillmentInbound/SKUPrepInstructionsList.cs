...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public partial class SKUPrepInstructionsList : List<SKUPrepInstructions>, IEquatable<SKUPrepInstructionsList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SKUPrepInstructionsList);
        }
