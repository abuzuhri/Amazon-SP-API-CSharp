...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetBillOfLadingResponse : IEquatable<GetBillOfLadingResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The payload for the getBillOfLading operation.</value>
        ...
        {
            return this.Equals(input as GetBillOfLadingResponse);
        }

        /// <summary>
        /// Returns true if GetBillOfLadingResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBillOfLadingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBillOfLadingResponse input)
        {
            if (input == null)
                return false;
