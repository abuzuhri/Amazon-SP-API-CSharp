...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillOfLadingDownloadURL : IEquatable<BillOfLadingDownloadURL>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BillOfLadingDownloadURL);
        }

        /// <summary>
        /// Returns true if BillOfLadingDownloadURL instances are equal
        /// </summary>
        /// <param name="input">Instance of BillOfLadingDownloadURL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillOfLadingDownloadURL input)
        {
            if (input == null)
                return false;
