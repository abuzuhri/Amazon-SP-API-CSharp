...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfirmTransportResponse : IEquatable<ConfirmTransportResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The payload for the confirmTransport operation.</value>
        ...
        {
            return this.Equals(input as ConfirmTransportResponse);
        }

        /// <summary>
        /// Returns true if ConfirmTransportResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfirmTransportResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfirmTransportResponse input)
        {
            if (input == null)
                return false;
