...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Notifications
{
    ...
    public partial class GetDestinationResponse : IEquatable<GetDestinationResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetDestinationResponse);
        }

        /// <summary>
        /// Returns true if GetDestinationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDestinationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDestinationResponse input)
        {
            if (input == null)
                return false;
