...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.MerchantFulfillment
{
    ...
    /// </summary>
    [DataContract]
    public partial class TermsAndConditionsNotAcceptedCarrier :  IEquatable<TermsAndConditionsNotAcceptedCarrier>, IValidatableObject
    {
        /// <summary>
        ...
        public TermsAndConditionsNotAcceptedCarrier(string carrierName = default(string))
        {
            ...
            if (carrierName == null)
            {
                throw new InvalidDataException("carrierName is a required property for TermsAndConditionsNotAcceptedCarrier and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TermsAndConditionsNotAcceptedCarrier);
        }
