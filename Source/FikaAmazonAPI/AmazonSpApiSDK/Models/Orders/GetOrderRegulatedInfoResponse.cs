...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetOrderRegulatedInfoResponse : IEquatable<GetOrderRegulatedInfoResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetOrderRegulatedInfoResponse(OrderRegulatedInfo payload = default(OrderRegulatedInfo), ErrorList errors = default(ErrorList))
        {
        ...
        {
            return this.Equals(input as GetOrderRegulatedInfoResponse);
        }
