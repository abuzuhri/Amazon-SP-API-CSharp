...
namespace FikaAmazonAPI.Services
{
    public class ShippingService : RequestService
    {
        ...
        public Shipment CreateShipment(CreateShipmentRequest parameterGetPricing) =>
            CreateShipmentAsync(parameterGetPricing).ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public Shipment GetShipment(string shipmentId, ParameterBasedPII parameterBasedPII) =>
            GetShipmentAsync(shipmentId, parameterBasedPII).ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public bool CancelShipment(string shipmentId) =>
            CancelShipmentAsync(shipmentId).ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public PurchaseLabelsResult PurchaseLabels(string shipmentId, PurchaseLabelsRequest purchaseLabelsRequest) =>
            PurchaseLabelsAsync(shipmentId, purchaseLabelsRequest).ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public RetrieveShippingLabelResult RetrieveShippingLabel(string shipmentId, string trackingId, RetrieveShippingLabelRequest retrieveShippingLabelRequest) =>
            RetrieveShippingLabelAsync(shipmentId, trackingId, retrieveShippingLabelRequest).ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public PurchaseShipmentResult PurchaseShipment(PurchaseShipmentRequest purchaseShipmentRequest) =>
            PurchaseShipmentAsync(purchaseShipmentRequest).ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public GetRatesResult GetRates(GetRatesRequest getRatesRequest) =>
            GetRatesAsync(getRatesRequest).ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public Account GetAccount() => GetAccountAsync().ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        public TrackingInformation GetTrackingInformation(string trackingId) =>
            GetTrackingInformationAsync(trackingId).ConfigureAwait(false).GetAwaiter().GetResult();
