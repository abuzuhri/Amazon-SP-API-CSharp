...
- [ ] [Token for PII(Personally Identifiable Information)](https://github.com/amzn/selling-partner-api-docs/blob/main/references/tokens-api/tokens_2021-03-01.md)
...
```powershell
Install-Package CSharpAmazonSpAPI -Version 1.0.2
```
